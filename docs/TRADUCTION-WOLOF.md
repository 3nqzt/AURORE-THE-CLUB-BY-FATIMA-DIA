...
>
> Une fois corrigé, ces textes seront reportés dans `src/AuroreApp.jsx`
> (objet `STRINGS.wo`, tableau `QUOTES.wo`, et les noms de jours / d'humeurs / de thèmes).
...
| entrée (singulier) | mbind | |
| EXPORT | GÉNNE | |
| ÉCRIRE | BIND | |
| Nouveau moment | Saa bu bees | |
| Humeur du moment | Xel ci saa si | |
| Heure | Waxtu | |
| Mon moment | Sama saa | |
| Qu'est-ce qui habite ton esprit aujourd'hui ? | Lan moo nekk ci sa xel tey ? | |
| Emojis | Emoji yi | |
| Photo / création | Nataal / liggéey | |
| Ajouter une photo | Yokk nataal | |
| Retirer | Dindi | |
| Au fil de la journée *(timeline)* | Yoonu bés bi | |
| Note ton humeur à différents moments | Bind sa xel ci jamono yu wuute | |
| SAUVEGARDER | DENC | |
| Ton journal t'attend. Commence à écrire. | Sa téere mu ngi lay xaar. Tàmbalee bind. | |
...
| Humeur dominante | Xel mi ëpp | |
| ce mois | ci weer wi | |
| Aucune entrée ce mois. Commence à écrire ✦ | Amul mbind ci weer wi. Tàmbalee bind ✦ | |
| Légende des humeurs | Tekki xel yi | |
...
| Sauvegardé ✓ | Denc na ✓ | |
| Langue | Làkk | |
| Thème de l'application | Melokaanu app bi | |
| Police de caractères | Araf yi | |
...
*Mois (Janvier…Décembre) : conservés en français, comme c'est l'usage courant au Sénégal. À adapter si besoin.*
